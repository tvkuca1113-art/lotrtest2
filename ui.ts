...
export class Interface {
    ...
    state() { const state = this.engine?.state; if (state === 'BOSS_INTRO')
        this.bossIntro();
    ...
    open(panel: string) { if (this.engine && ['BOSS_INTRO', 'DEFEATED', 'ENDING'].includes(this.engine.state))
